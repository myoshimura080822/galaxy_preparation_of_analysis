# CorrAndClusterForLogCountData/CorrAndClusterForLogCountData.py - a self annotated version of rgToolFactory.py generated by running rgToolFactory.py
# to make a new Galaxy tool called CorrAndClusterForLogCountData
# User admin@galaxy.org at 24/05/2015 08:31:39
# rgToolFactory.py
