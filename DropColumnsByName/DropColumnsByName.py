# DropColumnsByName/DropColumnsByName.py - a self annotated version of rgToolFactory.py generated by running rgToolFactory.py
# to make a new Galaxy tool called DropColumnsByName
# User admin@galaxy.org at 24/05/2015 09:47:31
# rgToolFactory.py
