# SummaryOfSailfishInfo/SummaryOfSailfishInfo.py - a self annotated version of rgToolFactory.py generated by running rgToolFactory.py
# to make a new Galaxy tool called SummaryOfSailfishInfo
# User admin@galaxy.org at 06/05/2015 08:31:17
# rgToolFactory.py
